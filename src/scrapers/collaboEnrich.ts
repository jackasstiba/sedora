...
// 「発売日」は 2026-09-15 追加: 物販記事（アベイル・しまむら等）は仕様表が「発売日 2026年9月19日(土)」で
// 「期間」の語が無く、収集元の一覧側の「期間 : 9月18日〜」（1日早い誤り）を訂正できなかった
// （実測 #245700 / #172978。タイトルは 9/19・本文も 9/19・一覧だけ 9/18）。
const PERIOD_LABEL_G = /(?:開催期間|開催日程|開催日|販売期間|実施期間|開催スケジュール|発売日|期間)\s*[:：]?/g;
