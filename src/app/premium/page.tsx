...
const DESCRIPTION =
  "フィギュア・トレカ・一番くじ・スニーカーなどで、定価より高く取引されている（プレ値の）アイテムの相場を、定価比の高い順にまとめています。発売済みで通常の一覧からは見えなくなった品も掲載。相場は駿河屋の中古価格・Xの実売（メルカリ等）を参照。";
    ...
    <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-6">
      ...
      <header className="mb-5">
        ...
        <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">
          定価より高く取引されている「プレ値」アイテムを、定価比の高い順に掲載。
          発売済みで通常の一覧からは見えなくなった品も含みます。
        </p>
